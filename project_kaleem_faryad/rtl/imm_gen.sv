    ...
    always_comb begin
        case (imm_src)
            ...
            // TODO: Implement remaining immediate types
             3'b001:   
               imm_ext = {{20{instruction[31]}},instruction[31:25],
               instruction[11:7]};  //S-type
             3'b010:
               imm_ext = {{19{instruction[31]}},instruction[31],instruction[7],instruction[30:25],
               instruction[11:8],1'b0}; //B-type
              3'b011:
               imm_ext = {instruction[31:12], 12'b0};// U-type
              3'b100:
               imm_ext = {{11{instruction[31]}},instruction[31],instruction[19:12],
